...
export const rarityLabel = /* @__PURE__ */ lookup<RarityId>({
  ...
  rare: m.rarity_rare,
  'holo-rare': m.rarity_holo_rare,
  'holo-rare-v': m.rarity_holo_rare_v,
  'holo-rare-vmax': m.rarity_holo_rare_vmax,
  'holo-rare-vstar': m.rarity_holo_rare_vstar,
  'double-rare': m.rarity_double_rare,
  'radiant-rare': m.rarity_radiant_rare,
  'amazing-rare': m.rarity_amazing_rare,
  'ultra-rare': m.rarity_ultra_rare,
  'illustration-rare': m.rarity_illustration_rare,
  'mega-attack-rare': m.rarity_mega_attack_rare,
  'special-illustration-rare': m.rarity_special_illustration_rare,
  'secret-rare': m.rarity_secret_rare,
  'hyper-rare': m.rarity_hyper_rare,
  'mega-hyper-rare': m.rarity_mega_hyper_rare,
  'black-white-rare': m.rarity_black_white_rare,
