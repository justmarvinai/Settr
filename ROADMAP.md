...
> Last updated: 2026-09-24 · Current phase: **v1.x · Your sets**: the **Mega Evolution series** ✅ built on `claude/great-edison-uri1z0` (M1–M6 are merged; the `v1.0.0` tag waits for your go) · question rounds 1–7 decided, rounds 8–9 open without blockers
...
| **v1.x · Your sets** | Your sets, one by one and era by era, once the core is fully functional (R2.5) | 1.x | ⏳ Mega Evolution ✅ built · Scarlet & Violet next |
